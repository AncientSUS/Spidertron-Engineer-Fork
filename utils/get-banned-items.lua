function get_banned_items(gun_prototypes, armor_prototypes, recipe_prototypes)
    ...
    for name, prototype in pairs(recipe_prototypes) do
        ...
        if not ingredients and prototype["normal"] then ingredients = prototype["normal"]["ingredients"] end
        if not ingredients and prototype["expensive"] then ingredients = prototype["expensive"]["ingredients"] end
